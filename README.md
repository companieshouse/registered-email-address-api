...
5. Open your browser and go to page http://chs.local/register-email-address
6. If you are using the api directly, then use this url: http://api.chs.local/registered-email-address
